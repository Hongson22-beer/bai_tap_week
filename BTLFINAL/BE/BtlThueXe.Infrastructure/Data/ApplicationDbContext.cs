       ...
       modelBuilder.Entity<HopDong>(entity =>
{
    ...
    entity.HasIndex(
        ...
        modelBuilder.Entity<KhachHang>(entity =>
        {
            ...
            entity.Property(e => e.AnhCccdMatTruoc).HasMaxLength(500).HasColumnName("anh_cccd_mat_truoc");
            entity.Property(e => e.AnhCccdMatSau).HasMaxLength(500).HasColumnName("anh_cccd_mat_sau");
            entity.Property(e => e.SoGplx).HasMaxLength(50).HasColumnName("so_gplx");
            entity.Property(e => e.AnhGplx).HasMaxLength(500).HasColumnName("anh_gplx");
            entity.Property(e => e.GplxDaXacMinh).HasColumnName("gplx_da_xac_minh");
            entity.Property(e => e.NganHang).HasMaxLength(100).HasColumnName("ngan_hang");
            entity.Property(e => e.SoTaiKhoan).HasMaxLength(50).HasColumnName("so_tai_khoan");
            entity.Property(e => e.ChuTaiKhoan).HasMaxLength(150).HasColumnName("chu_tai_khoan");
        ...
        modelBuilder.Entity<YeuCauThue>(entity =>
        {
            ...
            // =========================
            // THONG TIN NHAN / GIAO XE
            // =========================
            entity.Property(e => e.HinhThucNhanXe)
                .HasMaxLength(30)
                .HasColumnName("hinh_thuc_nhan_xe");
            ...
            entity.Property(e => e.SoDienThoaiNhan)
                .HasMaxLength(20)
                .HasColumnName("so_dien_thoai_nhan");

            entity.Property(e => e.DiaChiGiaoXe)
                .HasMaxLength(500)
                .HasColumnName("dia_chi_giao_xe");

            entity.Property(e => e.GhiChuGiaoXe)
                .HasMaxLength(1000)
                .HasColumnName("ghi_chu_giao_xe");
