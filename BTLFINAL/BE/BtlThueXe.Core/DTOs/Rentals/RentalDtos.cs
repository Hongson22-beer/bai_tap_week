...
namespace BtlThueXe.Core.DTOs.Rentals
{
    ...
    public class CreateRentalRequestDto
    {
        ...
        [Required]
        [RegularExpression("^(TAI_CUA_HANG|GIAO_TAN_NOI)$", ErrorMessage = "Hình thức nhận xe không hợp lệ.")]
        public string HinhThucNhanXe { get; set; } = "TAI_CUA_HANG";
        ...
        [StringLength(500)]
        public string? DiaChiGiaoXe { get; set; }
